 ...
 * PHP version 5.4
 *
 * @category   PieterHordijkTest
 * @author     Pieter Hordijk <info@pieterhordijk.com>
 * @copyright  Copyright (c) 2012 Pieter Hordijk
 * @license    http://www.opensource.org/licenses/mit-license.html  MIT License
 * @version    1.0.0
 */
namespace PieterHordijkTest;
...
/**
 * Simple SPL autoloader for the PieterHordijkTest libraries.
 *
 ...
 */
if (!defined('PIETERHORDIJK_TEST_DATA_DIR')) define('PIETERHORDIJK_TEST_DATA_DIR', __DIR__ . '/Data');
